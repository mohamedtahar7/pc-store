...
export default function AccessoriesPage() {
  ...
  const filteredProducts = useMemo(() => {
    return products.filter((p) => {
      // Force filter to only show products in the "Accessories" category
      ...
      return isAccessory && matchesSearch && matchesPrice;
    });
  }, [searchQuery, priceRange]);
      ...
      <div className="max-w-7xl mx-auto px-6">
        <header className="mb-12">
          <h1 className="text-4xl font-black text-slate-900 tracking-tight mb-4">
            Browse <span className="text-blue-600 italic">Accessories</span>
          </h1>
          <p className="text-slate-500 font-medium max-w-xl">
            Essential peripherals and precision tools for your setup.
          </p>
        </header>

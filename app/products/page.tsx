...
// Mock data import (Replace with your actual products array)
// import { products } from "@/data/products";

const ITEMS_PER_PAGE = 9;
const categories = ["All", "Builds", "Laptops", "Components", "Accessories"];
const priceRanges = [
      ...
      <div className="max-w-7xl mx-auto px-6">
        <header className="mb-12">
          <h1 className="text-4xl font-black text-slate-900 tracking-tight mb-4">
            Browse <span className="text-blue-600 italic">Inventory</span>
          </h1>
